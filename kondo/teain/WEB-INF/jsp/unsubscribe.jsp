			...
			<div id="contents">
				<div class="customer_ col1_">
					<div class="navitopicpath_">
						<a href="" class="topicpath_home_">ホーム</a>
						&gt;<a href="./menu.aspx">マイページ</a>
						&gt;<a href="/shop/customer/withdrawal.aspx">退会</a>
					</div>
						...
						<form method="post" action="delete" onSubmit="return confirmAction()">
							<table class="formdetail_ withdrawal_">
								<tbody>
									<tr>
										<th>
											<img class="must_" src="//d3iuyfi32mtj8g.cloudfront.net/img/sys/check.gif" alt="必須">メールアドレス
										</th>
										<td>
									...
									<tr>
										<th>
											<img class="must_" src="//d3iuyfi32mtj8g.cloudfront.net/img/sys/check.gif" alt="必須">パスワード
										</th>
										<td>
