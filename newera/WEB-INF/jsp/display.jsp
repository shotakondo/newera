...
<div id="contents">
    ...
    <div class="right" style="size:50%;">
        ...
        <p class="goods_price_" style="margin: 30px">
				...
				￥${data.price}
            </span></br></br></br><hr></br></br></br>

	<table border="0"><tr>
        
<td><span class="" style="font-size:1.3em;padding-right:70px">
                    
    57.7 - 61.5cm</span></td>
        <td><a href="cartadd?pid=${data.pid}"><input id="" type="image" class="btn_add_cart_" src="img/prd_detail_cart_in.png" alt=""></a></td></tr>
</table>
</br></br></br>
