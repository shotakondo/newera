...
<tr>
	...
	<td class="name_">
		...
		<div class="name1_"><a href="" title="${product.name}">${product.name}</a><p>（57.7 - 61.5cm）</p></div>
...
<td><a href="javascript:history.go(-1);" style="padding: 250px"><img src="img/cart_back.gif" alt="戻る（お買い物を続ける）" style=""></a></td>
