		...
		<div class="wrapper_">
			...
			<div class="cartlist_ order_col1_">
				<h1 class="common_headline1_">
					<strong>
						<img src="img/shopping_cart1.png" alt="SHOPPING CART">
					</strong>
					<span>
						ショッピングカート
					</span>
				...
				<div class="order_flow_">
					<center>
						<img src="img/order_step1.png" alt="STEP1 買い物かご">
					</center>
				</div>
				<form method="POST" action="purchaseprocedure" name="form">
					...
					<input type="hidden" name="refresh" value="true">
						<table class="formlist_ cartlist_" style="width:1100px; height: 215px">
							<tbody>
								<tr class="">
									<th class="title_cartlist" style="background-color:black;color: azure" colspan="2" >
										アイテム名 / 商品番号
									</th>
									<th class="qty_cartlist" style="background-color:black;color: azure">
										数量
									</th>
									<th class="money_cartlist" style="background-color:black;color: azure">
										金額
									</th>
									<th class style="background-color:black;color: azure">
									</th>
								</tr>
								<c:forEach var="product" items="${sessionScope.userBean.cart.products}">
									<tr>
										<td class="img_" style="width:200px;height:215px !important">
											<a href="productdetaildisplay?pid=${product.pid}" title="${product.name}" style="">
												<img src="<c:url value='${product.path}' />"  alt="${product.name}">
											</a>
										</td>
										<td class="name_">
											<div class="name_">
								...
								<tr class="total_line_">
									...
									<td class="button_">
										<input type="image" name="update" src="img/recount.gif" alt="再計算" tabindex="1">
									</td>
								</tr>
							</tbody>
						</table>
							...
							<tr>
								<td>
									<a href="javascript:history.go(-1);" style="">
										<img src="img/cart_back.gif" alt="戻る（お買い物を続ける）" style="">
									</a>
								</td>
								<td>
				...
				<p style="font-size:1.3em;margin: 50px">
					...
					◆カートに入れただけでは在庫は確保されませんのでご注意ください。
				</p>
			</div>
			<div id="footer">
