...
<table class="formdetail_ customer_">
	...
	<tr>
		...
		<td>
			<span class="efo checktype_mail is_required">
				<input value="" size="40" type="text" name="email" maxlength="100" id="mail" onblur="ecUtil.strConvert(this, false);" title="(例)sample@sample.jp	" placeholder="(例)sample@sample.jp	" class="classrequired">
			</span>
	...
	<tr>
		...
		<span class="efo checktype_cmail is_required">
			<input value="" size="40" type="text" name="email" maxlength="100" id="cmail" onblur="ecUtil.strConvert(this, false);" title="(例)sample@sample.jp	" placeholder="(例)sample@sample.jp	" class="classrequired">
		</span>
